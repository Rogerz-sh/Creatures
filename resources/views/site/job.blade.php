            ...
            <div class="wrap bg-white margin-top-20 margin-bottom-20 padding-10">
                ...
                <div class="col-xs-3 text-center">
                    ...
                    <div class="border-solid border-width-1 border-color-main margin-top-20 v-align bg-light-orange">
                        <div class="white padding-30 font-190" id="company_name"></div>
                    </div>
                </div>
                <div class="col-xs-9 no-padding-left">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-4"><h3 class="orange">年薪<span id="salary"></span></h3></div>
                    </div>
                    <div class="col-xs-12 dark-gray">
                        <div class="col-xs-4">学历要求： <span id="req_degree"></span></div>
                        <div class="col-xs-4">性别要求： <span id="req_sex"></span></div>
                        <div class="col-xs-4">年龄要求： <span id="req_age"></span></div>
                    </div>
                    <div class="col-xs-12 dark-gray margin-top-10">
                        <div class="col-xs-4">工作地点： <span id="work_area"></span></div>
                        <div class="col-xs-4">工作年限： <span id="years"></span></div>
                        <div class="col-xs-4">招聘人数： <span id="number"></span></div>
                    </div>
                    ...
                    <div class="col-xs-12">
                        <div class="padding-10 dark-gray">
                            <p class="line-height-10" id="job_desc"></p>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12">
                        <div class="padding-10 dark-gray">
                            <p class="line-height-10" id="job_requires"></p>
                        </div>
                    </div>
