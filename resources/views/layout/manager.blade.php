...
<div class="wrapper">
    <div id="header" class="bg-main">
        <div class="wrap padding-left-10 padding-right-10">
            <div class="float-left white"><h2 class="float-left"><i class="fa fa-cog"></i> 即沃 锐驰后台管理系统V1.0</h2></div>
            <div class="float-right">
                <div id="user">
                    <p class="white bold">欢迎您！ </p>
                    <p class="white bold">{{ $nickname }}</p>
                    <p><a href="/system/logout" class="btn btn-default btn-sm">退出系统</a></p>
                </div>
            </div>
            <div class="clear"></div>
        </div>
